...
class PermaModelTraining:
    ...
    def run(self): 
        ...
        for database in database_list:
            ...
            data_X = self.scaling_data.standardize_features(data_X, database)
            data_X, feature_importance_dict = self.feature_reduction.select_features_regression(data_X, data_y, database)
            data_X, top_features = self.feature_reduction.perform_pca(data_X, database)
